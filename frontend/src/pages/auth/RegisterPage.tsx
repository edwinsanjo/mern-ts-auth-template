            ...
            <div className="pt-32 flex-col">
                ...
                <div className="mb-6">
                    ...
                    <div className="flex mb-5 border-2 border-black border-opacity-25">
                        ...
                        <input size={30} className="focus:outline-none" placeholder="" type="text" value={name} onChange={(e) => setName(e.target.value)} />
                    </div>
                </div>
                ...
                <div className="">
                    ...
                    <div className="flex mb-5 border-2 border-black border-opacity-25">
                        ...
                        <input size={30} className="focus:outline-none" value={password} onChange={(e) => setPassword(e.target.value)} placeholder="" type={showPassword ? "text" : "password"} />
                        <div className="h-10 w-10 opacity-25 p-2 flex items-center" onClick={() => setShowPassword(!showPassword)}>
                            {
                                showPassword ?
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                ...
                <button className="text-white bg-black border-1 border-black w-full sm:px-16 py-3" onClick={() => submitHandler()} >Register</button>
            </div>
        </div>
    )
}